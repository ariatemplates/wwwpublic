...
{macro main()}
	<div class="tableTemplate">
		<h1>This page demonstrates the usage of the Table Template.</h1>

    <p>If you want to see how you can extend the Table Template please check out <a href="extending/index.html">this</a> example.</p>
